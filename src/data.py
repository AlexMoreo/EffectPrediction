...
FEATURE_HIERARCHY = {'all':FEATURE_SUBGROUP_PREFIXES}
for f in FEATURE_SUBGROUP_PREFIXES:
    father, soon = f.split('--')
    FEATURE_HIERARCHY[father] = FEATURE_HIERARCHY.get(father,[])+[f]
